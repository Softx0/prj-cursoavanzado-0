...
import static app.mpv.com.mpvapp.app.mpv.com.mpvapp.helper.Constant.ACTUALIZANDO_PLATAFORMA;
import static app.mpv.com.mpvapp.app.mpv.com.mpvapp.helper.Constant.CARGANDO;
import static app.mpv.com.mpvapp.app.mpv.com.mpvapp.helper.Constant.MY_PERMISSIONS_REQUEST_READ_CONTACTS;
import static app.mpv.com.mpvapp.app.mpv.com.mpvapp.helper.Constant.PODRUCTO_PUBLICADO;
import static app.mpv.com.mpvapp.app.mpv.com.mpvapp.helper.Constant.SUBIENDO_A_LA_PLATAFORMA;
...
public class ChoosePost extends AppCompatActivity {
    ...
    private void uploadFile() {
        ...
        if (filePath != null) {
            ...
            progressDialog.setTitle(SUBIENDO_A_LA_PLATAFORMA);
            progressDialog.show();
            ...
            storageReference.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(getApplicationContext(), PODRUCTO_PUBLICADO, Toast.LENGTH_LONG).show();
                    ...
                    .addOnProgressListener(taskSnapshot -> {
                        ...
                        progressDialog.setTitle(ACTUALIZANDO_PLATAFORMA);
    ...
    //Code for use the camera picker for now yet
